    ...
    <div class="row col-md-9 col-md-push-2">
                    <table class="table table-striped table-bordered table-hover">
                        <tr>
                            ...
                            <th> {{ trans('classes.td_update') }}</th>
                            <th> {{ trans('classes.td_delete') }}</th>                            
                        </tr>
                        @foreach ($all_classes as $class)
                           <tr>
                                ...
                                <td width="10%;">
                                        <?php echo link_to_route('class-edit',  $title = e(trans('classes.td_update')), $parameters = array($class->id), $attributes = array('class' => 'btn btn-success fa fa-edit')); ?>
                            </td>
