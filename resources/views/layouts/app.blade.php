        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li><a href="{{ url('/home') }}">{{trans('master_layout.home')}}</a></li>
                </ul>
                    ...
                    @else
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/logout') }}"><i class="fa fa-btn fa-sign-out"></i>{{trans('master_layout.logout')}}</a></li>
                            </ul>
                        </li>
                    @endif
                </ul>
