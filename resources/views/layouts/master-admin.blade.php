...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{url('/admin')}}">Админ Панел</a>
        </div>
        <!-- /.navbar-header -->
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    {{--</li>--}}
                    <li class="divider"></li>
                    <li><a href="{{url('/logout')}}"><i class="fa fa-sign-out fa-fw"></i> Изход</a>
                    </li>
                </ul>
                <!-- /.dropdown-user -->
            </li>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li>
                        <a href="{{url('admin')}}"><i class="fa fa-dashboard fa-fw"></i> Дашборд</a>
                    </li>
                    <li>
                        <a href="{{url('/awarding')}}"><i class="fa fa-trophy fa-fw"></i> Точкуване</a>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        <a href="{{url('/level')}}"><i class="fa fa-bar-chart-o fa-fw"></i> Нива</a>
                    </li>
                    <li>
